...
public extension Reactive where Base: UIViewController {
	...
	/// Can be used to pop the view controller if you want to do it before the scene's action disposes. If the view
	/// controller wasn't pushed, then this does nothing.
	/// - parameter animated: Set this value to true to animate the transition. Pass false if you are setting up a
	/// navigation controller before its view is displayed.
	/// - returns: A trigger Observable to notify you that it's done.
